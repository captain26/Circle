...
import { getOtherUserActivity } from "./helper/otherProfileApis.js";


export const OtherActivity = (props) => {
...
const Activity = () => {
    getOtherUserActivity(token,props.slug)
    .then((data) => {
    setActivity(data);
}).catch(() => setActivity([]))
}
                    ...
                    <center>
                      <Card key={index} class="card w-75 mb-5">
                        ...
                        />
                                                     ...
                                                     {/* modal */}
        <div class="modal fade" id="otheruseractivitylikemodal" tabindex="-1" role="dialog">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div onClick={() => setLikes(feed.post.reactions)}>
                  <p data-toggle="modal" data-target="#otheruseractivitylikemodal" style={{ alignContent: "left", fontSize: "14px", color: "#4d52b5", fontWeight: "bold", textAlign: "left", marginLeft: "15px", cursor: "pointer" }}>{feed.post.reactions.length} Likes</p>
                </div>
